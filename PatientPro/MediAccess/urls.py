...
from .views import my_patients, register, login, logout, patient_dashboard, doctor_dashboard, doctor_list, doctor_detail, update_doctor_details, home, patient_list, get_patient_detail, update_patient, update_patient_detail, delete_patient, get_patient_records, patient_records, department_list, department_doctors_list, update_doctor, department_patients_list, view_patient_record, download_medicine_description
...
urlpatterns = [
    ...
    path('download-medicine/', download_medicine_description, name='download_medicine'),
