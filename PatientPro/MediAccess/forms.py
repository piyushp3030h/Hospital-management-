...
class CustomUserCreationForm(forms.ModelForm):
    ...
    professional_license_number = forms.IntegerField(
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'full_name', 'email', 'password1', 'password2', 'user_type', 'professional_license_number']
    ...
    def clean(self):
        ...
        license_number = cleaned_data.get('professional_license_number')

        if user_type == 'doctor' and not license_number:
            self.add_error('professional_license_number', _('License number is required for doctors.'))
...
class PatientRecordForm(forms.ModelForm):
    ...
    class Meta:
        model = PatientRecord
        fields = ['diagnostics', 'observations', 'treatments', 'department', 'misc', 'doctor', 'medicine_description','is_discharged']
        widgets = {
            ...
            'medicine_description': forms.Textarea(attrs={'rows': 4}),
        }
